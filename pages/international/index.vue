  ...
  methods: {
    ...
    getMovies(seriesLimit) {
      try {
        ...
        this.$axios
          .get(`/videos/list/?categories=29&limit=${seriesLimit}`)
          .then(
            response => {
              ...
              //     "episodes"
              //   ];
              let tempdata = response.data.videos.category_videos["29"];
              let data = response.data.videos.category_videos["29"];
