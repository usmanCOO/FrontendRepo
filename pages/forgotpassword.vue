        ...
        <form novalidate @submit.prevent="subscribeNow">
          <div style=" padding-bottom:15px;">
            <div class="text-center">
              ...
              <br />
              <span class="text-grey">Enter your password below and click "Submit" to proceed.
</span>
            </div>
...
export default {
  ...
  methods: {
    ...
    subscribeNow() {
      console.log(this.$v);
      if (this.$v.Password.$error || this.$v.Password.$model == "") {
        ...
        console.log("c_password", this.c_Password);
        let obj = {
          msisdn: this.phone,
    ...
    async add_to_renewal() {
      ...
      console.log("obj", obj);
      axios
        .post("https://api.deikho.com/user/add", obj)
        .then(response => {
          var statusCode = response.status;
          console.log("status code", response);
          console.log("status code status", response.data.status);
