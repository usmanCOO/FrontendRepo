          ...
          axios
            ...
            .then(response => {
              ...
              if (status) {
                ...
                localStorage.setItem("msisdn", this.phone);
              } else {
                ...
                localStorage.setItem("msisdn", "");
                   ...
                   console.log(" adssa da sd",this.$route.query);
                   let query=this.$route.query;
               let episode_id=query.episode_id;
               let type=query.type
               let series_id=query.series_id
               let season_id=query.season_id;
               window.location.href = `https://deikho.com/watch/${episode_id}?type=series&series_id=${series_id}&season_id=${season_id}`
            })
            .catch(err => {
              return err;
            });
